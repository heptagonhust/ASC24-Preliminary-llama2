...
class CacheEngine:
    ...
    def __init__(
        ...
        self.num_layers = get_pipeline_model_parallel_layer_num(model_config.get_total_layers())
    ...
    def get_cache_block_size(
        ...
        num_layers = get_pipeline_model_parallel_layer_num(model_config.get_total_layers())
